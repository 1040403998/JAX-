...
from jax import grad, make_jaxpr, vmap
...
def predict(
    params: Tuple[f32[(10, 728)], f32[(10,)]], image: f32[(728,)]
) -> f32[(10,)]:
    w, b = params
...
def loss(params, images, targets):
    ...
    # print(make_jaxpr(predict)(params, images[0]))
    # print(make_jaxpr(batched_predict)(params, images))
