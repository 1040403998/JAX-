...
def manual_batched_predict(
    params: Tuple[f32[(10, 728)], f32[(10,)]], images: f32[(batch_size, 728)]) -> f32[(batch_size, 10)]:
    w, b = params
    images: f32[(batch_size, 1, 728)] = jnp.expand_dims(images, 1)
    logits: f32[(batch_size, 10)] = jnp.sum(w * images, axis=-1) + b
    return logits - logsumexp(logits)


batched_predict = manual_batched_predict
